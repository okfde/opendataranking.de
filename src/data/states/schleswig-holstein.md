...
criteria:
  ...
  - title: Aktualität der Daten
    ...
    text: Für den Vergleichszeitraum 2023 wurden 43,86% auf das Gesamtdatenvorkommen bezogen neu erstellt oder bearbeitet
  - title: Linked Data
    points: 2
    citations:
    ...
    text: Für den Vergleichszeitraum 2023 wurden 0,49% der neu erstellten Datensätze in einem Linked-Data-Format veröffentlicht
  - title: Freie Lizenzen
    ...
    text: Für den Vergleichszeitraum 2023 wurden 97,41% der aktualisierten oder neuen Datensätze mit Zero oder BY-Lizenz versehen
