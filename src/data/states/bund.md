...
criteria:
  ...
  - title: Portal für Open Data
    ...
    text: Es gibt aktuell kein offenes Datenportal der Bundesverwaltung. Angaben dieser Kategorie beziehen sich zu Vergleichszwecken auf das von der FITKO betriebene Datenportal für Deutschland GovData, das Daten aller Behördenebenen beinhaltet. Die zugrundeliegende Verwaltungsvereinbarung GovData ist [hier](https://www.govdata.de/documents/10156/18448/Verwaltungsvereinbarung_GovData_finale+Fassung.pdf) einsehbar
  ...
  - title: Aktualität der Daten
    ...
    text: Für den Vergleichszeitraum 2023 wurden 32,10% auf das Gesamtdatenvorkommen bezogen neu erstellt oder aktualisiert - diese Angaben bilden nur den Gesamtstand bei GovData ab; ohne zentrale zuliefernde Stelle kann der Datenstand des Bundes nicht bewertet werden.
  - title: Linked Data
    points: 0
    citations:
    ...
    text: Für den Vergleichszeitraum 2023 wurden 2,43% der neu erstellten Datensätze in einem Linked-Data-Format veröffentlicht - diese Angaben bilden nur den Gesamtstand bei GovData ab; ohne zentrale zuliefernde Stelle kann der Datenstand des Bundes nicht bewertet werden.
  - title: Freie Lizenzen
    ...
    text: Für den Vergleichszeitraum 2023 wurden 96,47% der aktualisierten oder neuen Datensätze mit Zero oder BY-Lizenz versehen - diese Angaben bilden nur den Gesamtstand bei GovData ab; ohne zentrale zuliefernde Stelle kann der Datenstand des Bundes nicht bewertet werden.
