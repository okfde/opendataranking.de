...
criteria:
  ...
  - title: Portal für Open Data
    ...
    text: Es gibt kein Portal des Bundes, die betreffenden Angaben beziehen sich lediglich zu Vergleichszwecken auf das von der FITKO betriebene Datenportal für Deutschland govdata
  ...
  - title: Aktualität der Daten
    ...
    text: Für den Vergleichszeitraum 2023 wurden 32,10% auf das Gesamtdatenvorkommen bezogen neu erstellt oder aktualisiert
  - title: Linked Data
    points: 0
    citations:
    ...
    text: Für den Vergleichszeitraum 2023 wurden 2,43% der neu erstellten Datensätze in einem Linked-Data-Format veröffentlicht
  - title: Freie Lizenzen
    ...
    text: Für den Vergleichszeitraum 2023 wurden 96,47% der aktualisierten oder neuen Datensätze mit Zero oder BY-Lizenz versehen
